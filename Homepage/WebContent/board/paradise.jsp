...
<body>
	...
	<form method="post" name="registerForm" action="register2.jsp"  id="join">
		<tr>
	...
	<div id="numberfull">
		...
		<span id="space">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>
		<span id="hire" onclick="location.href='../paradise/portfolio1.html'">&nbsp; Paradise</span>
		 
		<table id="loginbox">
			<tr>
				<form method="post" action="login2.jsp" id="login" name="loginForm">
				<td>
					<%
						if(isLogin){
	...
	<div id="middle">
		...
		<table class="postcontent" style="border: 1px double #619991;" id="writetable">
			<form method="post" action="write2.jsp" name="writeForm">
		...
		<form method="post" action="guestProcess2.jsp" name="guestForm">
	...
	<div id="footer">
		<div>
		<p id="footermail" style= "padding:10px 0;">quickbonak@gmail.com</p>
