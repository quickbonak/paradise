...
public class DBConnectionMgr {
    ...
    // 지금 단계에서는 우리 프로젝트의 사용을 위해 아래의 세줄만 기억하면 되는데,
    // 127.0.0.1 은 자기 컴퓨터의 주소를 뜻하고, 3306은 db에 설정한 포트번호를 의미한다.
    // kkk라는 데이터베이스를 기준으로 통신을 하고, utf-8 형식의 캐릭터셋을 사용한다.
    // 유저이름은 root 이고, 암호는 123321 이다.
    // 이 부분들을 변형하여 작업하면 될 것이다.
    _url = "jdbc:mysql://localhost:3306/homedb?useUnicode=true&characterEncoding=utf-8",
    _user = "root",
    _password = "123321";
