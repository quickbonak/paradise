...
public class DBConnectionMgr {
    ...
    /*_url = "jdbc:mysql://127.0.0.1:3306/mydb2?useUnicode=true&characterEncoding=EUC_KR",
    _user = "root",
    _password = "123321";*/
    ...
    public DBConnectionMgr() {
    	this ("localhost", "mysql", "root", "123321");
    }

    public DBConnectionMgr(String ip, String schedule, String user, String password) {
    	_url = "jdbc:mysql://"+ip+":3306/"+schedule+"?useUnicode=true&characterEncoding=EUC_KR";
    	_user = user;
    	_password = password;
    }
